...
<p>Olá <strong><?php echo esc($pedido->nome); ?>, o seu pedido <?php echo $pedido->codigo ?> saiu para entrega, logo ele chegará e você irá poder se deliciar com toda gostosura.</strong> no link abaixo para ativação da conta.</p>
