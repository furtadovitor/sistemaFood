      ...
      <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
              <div class="card-body">
                  ...
                  <div class="ui-widget">
                      <input id="query" name="query" placeholder="Pesquise por uma produto"
                          class="form-control bg-light mb-5">
                  </div>


                  <a href="<?= site_url("admin/produtos/criar"); ?>" class="btn btn-success mb-5">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <?= ($produto->deletado_em == null ? '<label class="badge badge-primary">Disponível</label>' : '<label class="badge badge-danger">Excluído</label>') ?>
          ...
          $("#query").autocomplete({
              ...
              select: function(event, ui) {
                  ...
                  if (ui.item.value == -1) {
                      ...
                      window.location.href = '<?= site_url('admin/produtos/show/'); ?>' + ui.item
                          .id;
